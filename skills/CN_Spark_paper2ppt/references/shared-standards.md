...
# 2. Export standalone speaker-notes DOCX (continuous manuscript, each paragraph prefixed with slide page number)
...
#   exports/<project_name>_speaker_notes.docx         -> continuous speaker-notes manuscript with slide-number paragraph prefixes
